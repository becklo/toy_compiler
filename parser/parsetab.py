...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','__init__.py',14),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','__init__.py',18),
  ('expression -> term','expression',1,'p_expression_term','__init__.py',22),
  ('term -> term TIMES factor','term',3,'p_term_times','__init__.py',26),
  ('term -> term DIVIDE factor','term',3,'p_term_div','__init__.py',30),
  ('term -> factor','term',1,'p_term_factor','__init__.py',34),
  ('factor -> NUMBER','factor',1,'p_factor_num','__init__.py',38),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','__init__.py',42),
]
